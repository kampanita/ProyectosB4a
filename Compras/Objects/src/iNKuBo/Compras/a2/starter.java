...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "iNKuBo.Compras.a2", "iNKuBo.Compras.a2.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "iNKuBo.Compras.a2.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
