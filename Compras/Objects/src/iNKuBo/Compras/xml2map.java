...
public class xml2map extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "iNKuBo.Compras.xml2map");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", iNKuBo.Compras.xml2map.class).invoke(this, new Object[] {null});
        else
...
public iNKuBo.Compras.xml2map._xmlelement  _createelement(String _name) throws Exception{
iNKuBo.Compras.xml2map._xmlelement _xe = null;
...
_xe = new iNKuBo.Compras.xml2map._xmlelement();
...
public Object  _elementtoobject(iNKuBo.Compras.xml2map._xmlelement _element) throws Exception{
anywheresoftware.b4a.objects.collections.Map _m = null;
iNKuBo.Compras.xml2map._xmlelement _child = null;
...
_child = (iNKuBo.Compras.xml2map._xmlelement)(group6.Get(index6));
...
public iNKuBo.Compras.xml2map._xmlelement  _getlastelement() throws Exception{
...
if (true) return (iNKuBo.Compras.xml2map._xmlelement)(_elements.Get((int) (_elements.getSize()-1)));
...
_m = new anywheresoftware.b4a.objects.collections.Map();
_m = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_elementtoobject((iNKuBo.Compras.xml2map._xmlelement)(_elements.Get((int) (0))))));
...
iNKuBo.Compras.xml2map._xmlelement _element = null;
