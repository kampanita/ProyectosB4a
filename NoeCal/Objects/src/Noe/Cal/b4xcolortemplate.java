...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Noe.Cal.b4xcolortemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Noe.Cal.b4xcolortemplate.class).invoke(this, new Object[] {null});
        else
...
public Noe.Cal.b4xcolortemplate._colorpickerpart _huebar = null;
public Noe.Cal.b4xcolortemplate._colorpickerpart _colorpicker = null;
public Noe.Cal.b4xcolortemplate._colorpickerpart _alphabar = null;
public int _borderscolor = 0;
public Noe.Cal.b4xdialog _xdialog = null;
...
int _r = 0;
int _w = 0;
Noe.Cal.b4xcolortemplate._colorpickerpart _cpp = null;
int _i = 0;
...
_cpp = (Noe.Cal.b4xcolortemplate._colorpickerpart)(group12[index12]);
...
_huebar = new Noe.Cal.b4xcolortemplate._colorpickerpart();
_colorpicker = new Noe.Cal.b4xcolortemplate._colorpickerpart();
_alphabar = new Noe.Cal.b4xcolortemplate._colorpickerpart();
 //BA.debugLineNum = 12;BA.debugLine="Private BordersColor As Int";
_borderscolor = 0;
 //BA.debugLineNum = 13;BA.debugLine="Private xDialog As B4XDialog";
_xdialog = new Noe.Cal.b4xdialog();
...
public Noe.Cal.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
Noe.Cal.b4xcolortemplate._colorpickerpart _cpp = null;
...
_cpp = new Noe.Cal.b4xcolortemplate._colorpickerpart();
...
public String  _drawcheckers(Noe.Cal.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public ResumableSub_Show(Noe.Cal.b4xcolortemplate parent,Noe.Cal.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Noe.Cal.b4xcolortemplate parent;
