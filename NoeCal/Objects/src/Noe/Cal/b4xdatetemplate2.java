...
String _data = "";
 //BA.debugLineNum = 146;BA.debugLine="Sub datatotexT(datos As Int) As String";
 //BA.debugLineNum = 147;BA.debugLine="Dim data As String";
_data = "";
 //BA.debugLineNum = 148;BA.debugLine="If datos<9 Then";
if (_datos<9) { 
 //BA.debugLineNum = 149;BA.debugLine="data=\"0\"&datos";
_data = "0"+BA.NumberToString(_datos);
 }else {
 //BA.debugLineNum = 151;BA.debugLine="data =datos";
_data = BA.NumberToString(_datos);
 };
 //BA.debugLineNum = 154;BA.debugLine="Return data";
...
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
 //BA.debugLineNum = 156;BA.debugLine="Private Sub DrawBox(c As B4XCanvas, clr As Int, x";
 //BA.debugLineNum = 157;BA.debugLine="Dim r As B4XRect";
_r = new anywheresoftware.b4a.objects.B4XCanvas.B4XRect();
 //BA.debugLineNum = 158;BA.debugLine="r.Initialize(x * boxW, y * boxH, x * boxW + boxW,";
_r.Initialize((float) (_x*_boxw),(float) (_y*_boxh),(float) (_x*_boxw+_boxw),(float) (_y*_boxh+_boxh));
 //BA.debugLineNum = 159;BA.debugLine="c.DrawRect(r, clr, True, 1dip)";
...
int _day = 0;
int _row = 0;
 //BA.debugLineNum = 64;BA.debugLine="Private Sub DrawDays";
 //BA.debugLineNum = 66;BA.debugLine="Dim where As String";
_where = "";
 //BA.debugLineNum = 67;BA.debugLine="Dim tipo2 As String";
_tipo2 = "";
 //BA.debugLineNum = 68;BA.debugLine="Dim rs As ResultSet";
_rs = new anywheresoftware.b4a.sql.SQL.ResultSetWrapper();
 //BA.debugLineNum = 69;BA.debugLine="Dim x As Int";
_x = 0;
 //BA.debugLineNum = 70;BA.debugLine="Dim y As Int";
_y = 0;
 //BA.debugLineNum = 71;BA.debugLine="Dim y2 As Int";
_y2 = 0;
 //BA.debugLineNum = 72;BA.debugLine="Dim color As Int";
_color = 0;
 //BA.debugLineNum = 74;BA.debugLine="lblMonth.Text = months.Get(month - 1)";
_lblmonth.setText(BA.ObjectToCharSequence(_months.Get((int) (_month-1))));
 //BA.debugLineNum = 75;BA.debugLine="lblYear.Text = year";
_lblyear.setText(BA.ObjectToCharSequence(_year));
 //BA.debugLineNum = 76;BA.debugLine="SetYearsButtonState";
_setyearsbuttonstate();
 //BA.debugLineNum = 77;BA.debugLine="cvs.ClearRect(cvs.TargetRect)";
_cvs.ClearRect(_cvs.getTargetRect());
 //BA.debugLineNum = 78;BA.debugLine="cvsBackground.ClearRect(cvsBackground.TargetRect)";
_cvsbackground.ClearRect(_cvsbackground.getTargetRect());
 //BA.debugLineNum = 79;BA.debugLine="Dim firstDayOfMonth As Long = DateUtils.setDate(y";
_firstdayofmonth = (long) (_dateutils._setdate(ba,_year,_month,(int) (1))-1);
 //BA.debugLineNum = 80;BA.debugLine="dayOfWeekOffset = (7 + DateTime.GetDayOfWeek(firs";
_dayofweekoffset = (int) ((7+__c.DateTime.GetDayOfWeek(_firstdayofmonth)-_firstday)%7);
 //BA.debugLineNum = 81;BA.debugLine="daysInMonth = DateUtils.NumberOfDaysInMonth(month";
_daysinmonth = _dateutils._numberofdaysinmonth(ba,_month,_year);
 //BA.debugLineNum = 90;BA.debugLine="Dim daysFont As B4XFont = xui.CreateDefaultBoldFo";
_daysfont = _xui.CreateDefaultBoldFont((float) (14));
 //BA.debugLineNum = 91;BA.debugLine="Dim daysFont2 As B4XFont = xui.CreateDefaultBoldF";
_daysfont2 = _xui.CreateDefaultBoldFont((float) (10));
 //BA.debugLineNum = 93;BA.debugLine="For day = 1 To daysInMonth";
{
final int step18 = 1;
final int limit18 = _daysinmonth;
_day = (int) (1) ;
for (;_day <= limit18 ;_day = _day + step18 ) {
 //BA.debugLineNum = 94;BA.debugLine="Dim row As Int = (day - 1 + dayOfWeekOffset) / 7";
_row = (int) ((_day-1+_dayofweekoffset)/(double)7);
 //BA.debugLineNum = 95;BA.debugLine="where =datatotexT(day)& \" \" & lblMonth.text&\" \"&";
_where = _datatotext(_day)+" "+_lblmonth.getText()+" "+_lblyear.getText();
 //BA.debugLineNum = 97;BA.debugLine="rs=sql.ExecQuery2(\"select * from Dias where Dia=";
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(_sql.ExecQuery2("select * from Dias where Dia=?",new String[]{_where})));
 //BA.debugLineNum = 99;BA.debugLine="If rs.RowCount>=1 Then";
if (_rs.getRowCount()>=1) { 
 //BA.debugLineNum = 100;BA.debugLine="rs.Position=0";
_rs.setPosition((int) (0));
 //BA.debugLineNum = 101;BA.debugLine="tipo2=rs.GetString(\"Tipo2\")";
_tipo2 = _rs.GetString("Tipo2");
 //BA.debugLineNum = 102;BA.debugLine="color=xui.Color_Yellow";
_color = _xui.Color_Yellow;
 //BA.debugLineNum = 104;BA.debugLine="Select tipo2.SubString2(0,1)";
switch (BA.switchObjectToInt(_tipo2.substring((int) (0),(int) (1)),"M","T","N","R")) {
case 0: {
 //BA.debugLineNum = 106;BA.debugLine="color=xui.Color_Red";
_color = _xui.Color_Red;
 break; }
case 1: {
 //BA.debugLineNum = 108;BA.debugLine="color=xui.Color_Magenta";
_color = _xui.Color_Magenta;
 break; }
case 2: {
 //BA.debugLineNum = 110;BA.debugLine="color=xui.Color_Green";
_color = _xui.Color_Green;
 break; }
case 3: {
 //BA.debugLineNum = 112;BA.debugLine="color=xui.Color_cyan";
_color = _xui.Color_Cyan;
 break; }
}
;
 //BA.debugLineNum = 115;BA.debugLine="x=(((dayOfWeekOffset + day - 1) Mod 7) + 0.5) *";
_x = (int) ((((_dayofweekoffset+_day-1)%7)+0.5)*_boxw);
 //BA.debugLineNum = 116;BA.debugLine="y=(row + 0.3)* boxH + vCorrection";
_y = (int) ((_row+0.3)*_boxh+_vcorrection);
 //BA.debugLineNum = 117;BA.debugLine="y2 = (row + 0.7)* boxH + vCorrection";
_y2 = (int) ((_row+0.7)*_boxh+_vcorrection);
 //BA.debugLineNum = 120;BA.debugLine="cvs.DrawText(day, x, y, daysFont, xui.color_whi";
_cvs.DrawText(ba,BA.NumberToString(_day),(float) (_x),(float) (_y),_daysfont,_xui.Color_White,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 //BA.debugLineNum = 123;BA.debugLine="cvs.DrawText(tipo2, x,	y2, daysFont2, xui.color";
_cvs.DrawText(ba,_tipo2,(float) (_x),(float) (_y2),_daysfont2,_xui.Color_White,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 //BA.debugLineNum = 126;BA.debugLine="x=(day - 1 + dayOfWeekOffset) Mod 7";
_x = (int) ((_day-1+_dayofweekoffset)%7);
 //BA.debugLineNum = 127;BA.debugLine="y2=( day - 1 + dayOfWeekOffset) / 7";
_y2 = (int) ((_day-1+_dayofweekoffset)/(double)7);
 //BA.debugLineNum = 129;BA.debugLine="DrawBox(cvsBackground, color, x, y2)";
_drawbox(_cvsbackground,_color,_x,_y2);
 }else {
 //BA.debugLineNum = 132;BA.debugLine="cvs.DrawText(day, (((dayOfWeekOffset + day - 1)";
...
_cvsbackground.Invalidate();
 //BA.debugLineNum = 138;BA.debugLine="cvs.Invalidate";
_cvs.Invalidate();
 //BA.debugLineNum = 139;BA.debugLine="End Sub";
return "";
}
public long  _getdate() throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Public Sub getDate As Long";
 //BA.debugLineNum = 164;BA.debugLine="Return selectedDate";
...
boolean _validday = false;
 //BA.debugLineNum = 188;BA.debugLine="Private Sub HandleMouse(x As Double, y As Double,";
 //BA.debugLineNum = 189;BA.debugLine="Dim boxX = x / boxW, boxY =  y / boxH As Int";
_boxx = (int) (_x/(double)_boxw);
_boxy = (int) (_y/(double)_boxh);
 //BA.debugLineNum = 190;BA.debugLine="Dim newSelectedDay As Int = boxY * 7 + boxX + 1 -";
_newselectedday = (int) (_boxy*7+_boxx+1-_dayofweekoffset);
 //BA.debugLineNum = 191;BA.debugLine="Dim validDay As Boolean = newSelectedDay > 0 And";
_validday = _newselectedday>0 && _newselectedday<=_daysinmonth;
 //BA.debugLineNum = 192;BA.debugLine="If move Then";
if (_move) { 
 //BA.debugLineNum = 193;BA.debugLine="If newSelectedDay = tempSelectedDay Then Return";
if (_newselectedday==_tempselectedday) { 
if (true) return "";};
 //BA.debugLineNum = 194;BA.debugLine="cvsBackground.ClearRect(cvsBackground.TargetRect";
_cvsbackground.ClearRect(_cvsbackground.getTargetRect());
 //BA.debugLineNum = 195;BA.debugLine="tempSelectedDay = newSelectedDay";
_tempselectedday = _newselectedday;
 //BA.debugLineNum = 196;BA.debugLine="If validDay Then";
if (_validday) { 
 //BA.debugLineNum = 197;BA.debugLine="DrawBox(cvsBackground, HighlightedColor, boxX,";
_drawbox(_cvsbackground,_highlightedcolor,_boxx,_boxy);
 };
 }else {
 //BA.debugLineNum = 200;BA.debugLine="cvsBackground.ClearRect(cvsBackground.TargetRect";
_cvsbackground.ClearRect(_cvsbackground.getTargetRect());
 //BA.debugLineNum = 201;BA.debugLine="If validDay Then";
if (_validday) { 
 //BA.debugLineNum = 202;BA.debugLine="SelectDay(newSelectedDay)";
_selectday(_newselectedday);
 //BA.debugLineNum = 203;BA.debugLine="If CloseOnSelection Then";
...
public String  _selectday(int _day) throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Private Sub SelectDay(day As Int)";
 //BA.debugLineNum = 181;BA.debugLine="selectedDate = DateUtils.setDate(year, month, day";
_selecteddate = _dateutils._setdate(ba,_year,_month,_day);
 //BA.debugLineNum = 182;BA.debugLine="selectedDay = day";
_selectedday = _day;
 //BA.debugLineNum = 183;BA.debugLine="selectedMonth = month";
_selectedmonth = _month;
 //BA.debugLineNum = 184;BA.debugLine="selectedYear = year";
_selectedyear = _year;
 //BA.debugLineNum = 185;BA.debugLine="End Sub";
return "";
}
public String  _setdate(long _date) throws Exception{
 //BA.debugLineNum = 167;BA.debugLine="Public Sub setDate(date As Long)";
 //BA.debugLineNum = 169;BA.debugLine="If lblYear.IsInitialized = False Then";
if (_lblyear.IsInitialized()==__c.False) { 
 //BA.debugLineNum = 170;BA.debugLine="selectedDate = date";
_selecteddate = _date;
 //BA.debugLineNum = 171;BA.debugLine="Return 'the date will be set after the layout is";
if (true) return "";
 };
 //BA.debugLineNum = 173;BA.debugLine="year = DateTime.GetYear(date)";
_year = __c.DateTime.GetYear(_date);
 //BA.debugLineNum = 174;BA.debugLine="month = DateTime.GetMonth(date)";
_month = __c.DateTime.GetMonth(_date);
 //BA.debugLineNum = 175;BA.debugLine="SelectDay(DateTime.GetDayOfMonth(date))";
_selectday(__c.DateTime.GetDayOfMonth(_date));
 //BA.debugLineNum = 176;BA.debugLine="lblYear.Text = year";
_lblyear.setText(BA.ObjectToCharSequence(_year));
 //BA.debugLineNum = 177;BA.debugLine="lblMonth.Text = months.Get(month - 1)";
_lblmonth.setText(BA.ObjectToCharSequence(_months.Get((int) (_month-1))));
 //BA.debugLineNum = 178;BA.debugLine="End Sub";
return "";
}
public String  _setyearsbuttonstate() throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Private Sub SetYearsButtonState";
 //BA.debugLineNum = 142;BA.debugLine="btnYearLeft.Enabled = year > MinYear";
_btnyearleft.setEnabled(_year>_minyear);
 //BA.debugLineNum = 143;BA.debugLine="btnYearRight.Enabled = year < MaxYear";
