...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Noe.Cal.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Noe.Cal.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(Noe.Cal.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public Noe.Cal.b4xformatter._b4xformatdata  _copyformatdata(Noe.Cal.b4xformatter._b4xformatdata _data) throws Exception{
Noe.Cal.b4xformatter._b4xformatdata _d = null;
...
_d = new Noe.Cal.b4xformatter._b4xformatdata();
...
public Noe.Cal.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
Noe.Cal.b4xformatter._b4xformatdata _d = null;
...
Noe.Cal.b4xformatter._b4xformatdata _data = null;
...
public Noe.Cal.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (Noe.Cal.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public Noe.Cal.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
Noe.Cal.b4xformatter._b4xformatdata _d = null;
...
_d = (Noe.Cal.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public Noe.Cal.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
