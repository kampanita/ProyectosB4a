...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Noe.Cal.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Noe.Cal.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public Noe.Cal.b4xfloattextfield _searchfield = null;
...
_searchfield = new Noe.Cal.b4xfloattextfield();
...
__c.LogImpl("915859743","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(Noe.Cal.b4xsearchtemplate parent,Noe.Cal.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Noe.Cal.b4xsearchtemplate parent;
