...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Noe.Cal.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Noe.Cal.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public Noe.Cal.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new Noe.Cal.anotherprogressbar();
...
public ResumableSub_Show(Noe.Cal.b4xtimedtemplate parent,Noe.Cal.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Noe.Cal.b4xtimedtemplate parent;
