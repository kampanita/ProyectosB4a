...
mostCurrent._activity.LoadLayout("ver2",mostCurrent.activityBA);
 //BA.debugLineNum = 41;BA.debugLine="sql.Initialize(File.DirInternal, \"NoeCal.db\", Fal";
_sql.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"NoeCal.db",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 42;BA.debugLine="Dim años As List";
_años = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 43;BA.debugLine="Dim meses As List";
_meses = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 44;BA.debugLine="años.Initialize";
_años.Initialize();
 //BA.debugLineNum = 45;BA.debugLine="meses.Initialize";
_meses.Initialize();
 //BA.debugLineNum = 47;BA.debugLine="DateTime.DateFormat=\"yyyy\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy");
 //BA.debugLineNum = 48;BA.debugLine="For a=DateTime.GetYear(DateTime.Now)-5 To DateTim";
{
final int step8 = 1;
final int limit8 = (int) (anywheresoftware.b4a.keywords.Common.DateTime.GetYear(anywheresoftware.b4a.keywords.Common.DateTime.getNow())+5);
...
for (;_a <= limit8 ;_a = _a + step8 ) {
 //BA.debugLineNum = 49;BA.debugLine="años.Add(a)";
_años.Add((Object)(_a));
 }
};
 //BA.debugLineNum = 51;BA.debugLine="SpinnerAno2.AddAll(años)";
mostCurrent._spinnerano2.AddAll(_años);
 //BA.debugLineNum = 52;BA.debugLine="DateTime.DateFormat=\"MMM\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("MMM");
 //BA.debugLineNum = 53;BA.debugLine="meses=DateUtils.GetMonthsNames";
_meses = mostCurrent._dateutils._getmonthsnames(mostCurrent.activityBA);
 //BA.debugLineNum = 54;BA.debugLine="SpinnerMEs2.AddAll(meses)";
mostCurrent._spinnermes2.AddAll(_meses);
 //BA.debugLineNum = 55;BA.debugLine="SpinnerAno2.SelectedIndex=5 '<< este año";
mostCurrent._spinnerano2.setSelectedIndex((int) (5));
 //BA.debugLineNum = 56;BA.debugLine="SpinnerMEs2.SelectedIndex=DateTime.GetMonth(DateT";
mostCurrent._spinnermes2.setSelectedIndex((int) (anywheresoftware.b4a.keywords.Common.DateTime.GetMonth(anywheresoftware.b4a.keywords.Common.DateTime.getNow())-1));
...
if (_userclosed) { 
 //BA.debugLineNum = 76;BA.debugLine="Activity.LoadLayout(\"Layout\")";
...
String _año = "";
 ...
 //BA.debugLineNum = 61;BA.debugLine="DateTime.DateFormat=\"MM\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("MM");
 //BA.debugLineNum = 62;BA.debugLine="Log(DateTime.Now)";
anywheresoftware.b4a.keywords.Common.LogImpl("82949122",BA.NumberToString(anywheresoftware.b4a.keywords.Common.DateTime.getNow()),0);
 //BA.debugLineNum = 63;BA.debugLine="Log(DateTime.Date(DateTime.Now))";
anywheresoftware.b4a.keywords.Common.LogImpl("82949123",anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow()),0);
 //BA.debugLineNum = 64;BA.debugLine="Dim mes As String =DateTime.Date(DateTime.Now)";
_mes = anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 65;BA.debugLine="Log(mes)";
anywheresoftware.b4a.keywords.Common.LogImpl("82949125",_mes,0);
 //BA.debugLineNum = 67;BA.debugLine="DateTime.DateFormat=\"yyyy\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("yyyy");
 //BA.debugLineNum = 68;BA.debugLine="Dim año As String =DateTime.Date(DateTime.Now)";
_año = anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 69;BA.debugLine="Log(año)";
anywheresoftware.b4a.keywords.Common.LogImpl("82949129",_año,0);
 //BA.debugLineNum = 70;BA.debugLine="VerCalendario(mes, año)";
...
Object _ddd = null;
 //BA.debugLineNum = 124;BA.debugLine="Sub crea_dia(lista As List) As B4XView";
 //BA.debugLineNum = 125;BA.debugLine="Dim p As B4XView= xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 126;BA.debugLine="p.SetLayoutAnimated(100,0,0,100%x,36dip)";
_p.SetLayoutAnimated((int) (100),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (36)));
 //BA.debugLineNum = 127;BA.debugLine="p.LoadLayout(\"ver_cal_row\")";
_p.LoadLayout("ver_cal_row",mostCurrent.activityBA);
 //BA.debugLineNum = 128;BA.debugLine="Dim where As String";
_where = "";
 //BA.debugLineNum = 129;BA.debugLine="Dim rs As ResultSet";
_rs = new anywheresoftware.b4a.sql.SQL.ResultSetWrapper();
 //BA.debugLineNum = 130;BA.debugLine="Dim lista_tipos As List";
_lista_tipos = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 131;BA.debugLine="lista_tipos.Initialize";
_lista_tipos.Initialize();
 //BA.debugLineNum = 133;BA.debugLine="For Each ddd In lista";
{
...
_ddd = group8.Get(index8);
 //BA.debugLineNum = 134;BA.debugLine="where = ddd & \" \" & SpinnerMEs2.SelectedItem&\" \"";
_where = BA.ObjectToString(_ddd)+" "+mostCurrent._spinnermes2.getSelectedItem()+" "+mostCurrent._spinnerano2.getSelectedItem();
 //BA.debugLineNum = 135;BA.debugLine="rs=sql.ExecQuery2(\"select tipo2 from Dias where";
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(_sql.ExecQuery2("select tipo2 from Dias where Dia=?",new String[]{_where})));
 //BA.debugLineNum = 136;BA.debugLine="If rs.RowCount>1 Then";
if (_rs.getRowCount()>1) { 
 //BA.debugLineNum = 137;BA.debugLine="lista_tipos.add(rs.GetString(\"Tipo2\"))";
_lista_tipos.Add((Object)(_rs.GetString("Tipo2")));
 }else {
 //BA.debugLineNum = 139;BA.debugLine="lista_tipos.Add(\"\")";
_lista_tipos.Add((Object)(""));
 };
 }
};
 //BA.debugLineNum = 142;BA.debugLine="cal_dia1.Text=lista.Get(0)";
mostCurrent._cal_dia1.setText(BA.ObjectToCharSequence(_lista.Get((int) (0))));
 //BA.debugLineNum = 143;BA.debugLine="cal_tipo1.Text=lista_tipos.Get(0)";
mostCurrent._cal_tipo1.setText(BA.ObjectToCharSequence(_lista_tipos.Get((int) (0))));
 //BA.debugLineNum = 144;BA.debugLine="If cal_tipo1.text<>\"\" Then";
if ((mostCurrent._cal_tipo1.getText()).equals("") == false) { 
 //BA.debugLineNum = 145;BA.debugLine="Select cal_tipo1.Text.SubString(1)";
switch (BA.switchObjectToInt(mostCurrent._cal_tipo1.getText().substring((int) (1)),"M","N","R")) {
case 0: {
 //BA.debugLineNum = 147;BA.debugLine="cal_tipo1.Color=xui.Color_Red";
mostCurrent._cal_tipo1.setColor(_xui.Color_Red);
 break; }
case 1: {
 //BA.debugLineNum = 149;BA.debugLine="cal_tipo1.Color=xui.Color_Magenta";
mostCurrent._cal_tipo1.setColor(_xui.Color_Magenta);
 break; }
case 2: {
 //BA.debugLineNum = 151;BA.debugLine="cal_tipo1.Color=xui.Color_Green";
mostCurrent._cal_tipo1.setColor(_xui.Color_Green);
 break; }
}
;
 };
 //BA.debugLineNum = 154;BA.debugLine="cal_dia2.Text=lista.Get(1)";
mostCurrent._cal_dia2.setText(BA.ObjectToCharSequence(_lista.Get((int) (1))));
 //BA.debugLineNum = 155;BA.debugLine="cal_tipo2.Text=lista_tipos.Get(1)";
mostCurrent._cal_tipo2.setText(BA.ObjectToCharSequence(_lista_tipos.Get((int) (1))));
 //BA.debugLineNum = 156;BA.debugLine="cal_dia3.Text=lista.Get(2)";
mostCurrent._cal_dia3.setText(BA.ObjectToCharSequence(_lista.Get((int) (2))));
 //BA.debugLineNum = 157;BA.debugLine="cal_tipo3.Text=lista_tipos.Get(2)";
mostCurrent._cal_tipo3.setText(BA.ObjectToCharSequence(_lista_tipos.Get((int) (2))));
 //BA.debugLineNum = 158;BA.debugLine="cal_dia4.Text=lista.Get(3)";
mostCurrent._cal_dia4.setText(BA.ObjectToCharSequence(_lista.Get((int) (3))));
 //BA.debugLineNum = 159;BA.debugLine="cal_tipo4.Text=lista_tipos.Get(3)";
mostCurrent._cal_tipo4.setText(BA.ObjectToCharSequence(_lista_tipos.Get((int) (3))));
 //BA.debugLineNum = 160;BA.debugLine="cal_dia5.Text=lista.Get(4)";
mostCurrent._cal_dia5.setText(BA.ObjectToCharSequence(_lista.Get((int) (4))));
 //BA.debugLineNum = 161;BA.debugLine="cal_tipo5.Text=lista_tipos.Get(4)";
mostCurrent._cal_tipo5.setText(BA.ObjectToCharSequence(_lista_tipos.Get((int) (4))));
 //BA.debugLineNum = 162;BA.debugLine="cal_dia6.Text=lista.Get(5)";
mostCurrent._cal_dia6.setText(BA.ObjectToCharSequence(_lista.Get((int) (5))));
 //BA.debugLineNum = 163;BA.debugLine="cal_tipo6.Text=lista_tipos.Get(5)";
mostCurrent._cal_tipo6.setText(BA.ObjectToCharSequence(_lista_tipos.Get((int) (5))));
 //BA.debugLineNum = 164;BA.debugLine="cal_dia7.Text=lista.Get(6)";
mostCurrent._cal_dia7.setText(BA.ObjectToCharSequence(_lista.Get((int) (6))));
 //BA.debugLineNum = 165;BA.debugLine="cal_tipo7.Text=lista_tipos.Get(6)";
...
public static String  _spinnerano2_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Private Sub SpinnerAno2_ItemClick (Position As Int";
 //BA.debugLineNum = 176;BA.debugLine="End Sub";
return "";
}
public static String  _spinnermes2_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Private Sub SpinnerMEs2_ItemClick (Position As Int";
...
int _i = 0;
 //BA.debugLineNum = 80;BA.debugLine="Sub VerCalendario(mes As Int, año As Int)";
 //BA.debugLineNum = 81;BA.debugLine="Grid2.Clear";
mostCurrent._grid2._clear();
 //BA.debugLineNum = 82;BA.debugLine="Dim dias_mes As Int";
_dias_mes = 0;
 //BA.debugLineNum = 84;BA.debugLine="dias_mes=DateUtils.NumberOfDaysInMonth(mes,año)";
_dias_mes = mostCurrent._dateutils._numberofdaysinmonth(mostCurrent.activityBA,_mes,_año);
 //BA.debugLineNum = 85;BA.debugLine="Log(dias_mes)";
anywheresoftware.b4a.keywords.Common.LogImpl("83080197",BA.NumberToString(_dias_mes),0);
 //BA.debugLineNum = 87;BA.debugLine="Dim lista_dias As List";
_lista_dias = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 88;BA.debugLine="lista_dias.initialize";
_lista_dias.Initialize();
 //BA.debugLineNum = 89;BA.debugLine="For i=1 To dias_mes";
{
final int step7 = 1;
final int limit7 = _dias_mes;
_i = (int) (1) ;
for (;_i <= limit7 ;_i = _i + step7 ) {
 //BA.debugLineNum = 90;BA.debugLine="lista_dias.Add(i)";
_lista_dias.Add((Object)(_i));
 //BA.debugLineNum = 91;BA.debugLine="Grid2.Add(crea_dia(lista_dias),1)";
