...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "Noe.Cal", "Noe.Cal.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "Noe.Cal.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 ...
 //BA.debugLineNum = 16;BA.debugLine="If Not (File.Exists(File.DirInternal,\"NoeCal.db\")";
if (anywheresoftware.b4a.keywords.Common.Not(anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"NoeCal.db"))) { 
 //BA.debugLineNum = 17;BA.debugLine="File.Copy(File.DirAssets, \"NoeCal.db\",File.DirIn";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"NoeCal.db",anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"NoeCal.db");
 };
 //BA.debugLineNum = 19;BA.debugLine="Dim locale As JavaObject";
_locale = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 20;BA.debugLine="locale.InitializeNewInstance(\"java.util.Locale\",";
...
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 22;BA.debugLine="jo.InitializeStatic(\"java.util.Locale\").RunMethod";
