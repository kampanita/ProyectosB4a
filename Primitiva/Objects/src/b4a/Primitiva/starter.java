...
anywheresoftware.b4j.object.JavaObject _jo = null;
 ...
 //BA.debugLineNum = 18;BA.debugLine="If Not (File.Exists(File.DirInternal,\"primi.db\")";
if (anywheresoftware.b4a.keywords.Common.Not(anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"primi.db"))) { 
 //BA.debugLineNum = 19;BA.debugLine="File.Copy(File.DirAssets, \"primi.db\",File.DirInt";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"primi.db",anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"primi.db");
 ...
 //BA.debugLineNum = 22;BA.debugLine="Dim locale As JavaObject";
_locale = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 23;BA.debugLine="locale.InitializeNewInstance(\"java.util.Locale\",";
_locale.InitializeNewInstance("java.util.Locale",new Object[]{(Object)("es")});
 //BA.debugLineNum = 24;BA.debugLine="Dim jo As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 25;BA.debugLine="jo.InitializeStatic(\"java.util.Locale\").RunMethod";
...
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 ...
 //BA.debugLineNum = 31;BA.debugLine="Service.StopAutomaticForeground 'Starter service";
